...
- **Column collapse (outline-style, #64)**: a thin row above the column headers holds **+/−** toggles per **collapsible unit** —
  `qty+hours` (the breakdown of effort), Effort, Duration, Progress, Status, Assignee, Plan, Actual, Notes (**No. and Task name are always shown**).
